...
// * This interface covers both the "classic" (Scout) and
...
const double EMPTY_MASS    = 675900.0;
...
// ==========================================================
// Interface for derived vessel class: Scout
// ==========================================================

class Scout: public VESSEL3 {
	friend class AAP;
...
public:
	Scout (OBJHANDLE hObj, int fmodel);
	~Scout ();
	...
	UINT anim_gear01;       // handle for landing gear animation
	UINT anim_gear02;       // handle for landing gear animation
	UINT anim_gear03;       // handle for landing gear animation
	UINT anim_gear04;       // handle for landing gear animation
	UINT anim_gear05;       // handle for landing gear animation
	UINT anim_gear06;       // handle for landing gear animation
	UINT anim_gear07;       // handle for landing gear animation
	UINT anim_gear08;       // handle for landing gear animation
	UINT anim_gear09;       // handle for landing gear animation
	UINT anim_gear10;       // handle for landing gear animation
...
private:
	MGROUP_TRANSFORM *RGear02T01, *RGear01R01, *RFootR01, *RNull02R01;
	MGROUP_TRANSFORM *LGear02T01, *LGear01R01, *LFootR01, *LNull02R01;
	MGROUP_TRANSFORM *CGear02T01, *CGear01R01, *CFootR01, *CNull02R01;
...
public:
	DGPanelElement (Scout *_dg): PanelElement (dg), dg(_dg) {}
...
#define MESHGRP_BODY             0
#define MESHGRP_TURRET           1
#define MESHGRP_CCOVERL          2
#define MESHGRP_CCOVERR          3
#define MESHGRP_CFOOT            4
#define MESHGRP_CGEAR01          5
#define MESHGRP_CGEAR02          6
#define MESHGRP_CNULL01          7
#define MESHGRP_CNULL02          8
#define MESHGRP_FWHEELWELL       9
#define MESHGRP_LCOVER01        10
#define MESHGRP_LCOVER02        11
#define MESHGRP_LENGINE         12
#define MESHGRP_LFOOT           13
#define MESHGRP_LGEAR01         14
#define MESHGRP_LGEAR02         15
#define MESHGRP_LNULL01         16
#define MESHGRP_LNULL02         17
#define MESHGRP_LWHEELWELL      18
#define MESHGRP_RCOVER01        19
#define MESHGRP_RCOVER02        20
#define MESHGRP_RENGINE         21
#define MESHGRP_RFOOT           22
#define MESHGRP_RGEAR01         23
#define MESHGRP_RGEAR02         24
#define MESHGRP_RNULL01         25
#define MESHGRP_RNULL02         26
#define MESHGRP_RWHEELWELL      27
#define MESHGRP_WINDSHIELD      28
