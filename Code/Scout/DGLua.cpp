...
Scout *lua_toDG (lua_State *L, int idx = 1);
...
int Scout::Lua_InitInterpreter (void *context)
{
...
int Scout::Lua_InitInstance (void *context)
{
	lua_State *L = (lua_State*)context;
...
Scout *lua_toDG (lua_State *L, int idx)
{
...
static Scout::DoorStatus DGaction[4] = {
	Scout::DOOR_CLOSING,
	Scout::DOOR_OPENING,
	Scout::DOOR_CLOSING,
	Scout::DOOR_OPENING
